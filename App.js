...
const App = () => {
  ...
  const resetShop = () => {
    Alert.alert(
      "Confirm",
      "Are you sure you want to reset? Everything will be deleted!",
      [
  ...
  const getSalesSummary = () => {
    ...
    filteredSales.forEach(({ type, quantity, total }) => {
      if (summary[type]) {
      ...
      <ScrollView>
        ...
        <View style={styles.containerBase}>
          <View style={styles.registerContainer}>
            <Text style={styles.label}>ልብስ መመዝገቢያ</Text>
            <TextInput
            ...
            <Text style={styles.label}>የተመዘገቡ ልብሶች</Text>
            <FlatList
              data={clothes}
          ...
          <View style={styles.sellContainer}>
            <Text style={styles.label}>ልብስ መሸጫ</Text>
            <View style={styles.picker}>
              <Picker
                ...
                style={styles.input}
              >
                <Picker.Item label="ልብስ ስም" value="" />
                {clothes.map((cloth) => (
                  <Picker.Item
                    key={cloth.type}
                    label={cloth.type}
            ...
            <Text style={styles.label}>የተሸጡ ልብሶች</Text>
            <View style={styles.picker}>
              <Picker
                selectedValue={selectedType}
                onValueChange={(value) => setSelectedType(value)}
              >
                <Picker.Item label="ሁሉም አይነት" value="" />
                {clothes.map((cloth) => (
                  <Picker.Item
                    key={cloth.type}
                    label={cloth.type}
